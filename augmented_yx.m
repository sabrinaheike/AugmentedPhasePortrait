        ...
        for i=1:size(H,1)
            ...
            if plotrh ==1
                ...
                if isnumeric(eval(h))==1                   
                    % constant nullcline
                    hold on
                    plot([eval(h) eval(h)],[miny,maxy], 'LineStyle', '--', 'Color', CMH(i*2+trivh,:), 'LineWidth', 2,'DisplayName','X-Nullcline');
                else
                    hold on
                ...
                for m=1:length(xaxish)
                    for n = 1:length(yaxish)
                        ...
                        if isreal(Lhv)==1&& Lhv >0 &&xt>minx &&yt>miny
                            hold on
                            plot([xt,xt],[yt,yt],'MarkerFaceColor',CMH(2*i+trivh,:),'MarkerEdgeColor',CMH(2*i+trivh,:),'MarkerSize',8,...
                                'Marker','+',...
                                'LineStyle','-','LineWidth',2, 'HandleVisibility','off');
                        elseif isreal(Lhv)==1 && Lhv<0 &&xt>minx &&yt>miny
                            hold on
                            plot([xt,xt],[yt,yt],'MarkerFaceColor',CMH(2*i+trivh,:),'MarkerEdgeColor',CMH(2*i+trivh,:),'MarkerSize',10,...
                                'Marker','_',...
                                'LineStyle','-','LineWidth',2, 'HandleVisibility','off');
                        end      
                    end
        ...
        for j=1:size(K,1)
            ...
            if plotrk ==1
                ...
                if isnumeric(eval(k))==1
                    % constant nullcline
                    hold on
                    plot([minx, maxx],[eval(k) eval(k)], 'LineStyle', '--', 'Color', CMK(2*j+countk,:), 'LineWidth', 2,'DisplayName','Y-Nullcline');
                else
                    hold on
                    fplot(kf, [minx,maxx],'LineStyle', '--', 'Color', CMK(2*j+countk,:), 'LineWidth', 2,'DisplayName','Y-Nullcline');
                end
                ...
                % plot the root-curve
                hold on
                fimplicit(Lk,'Color',CMK(2*j+countk,:),'LineWidth',1.5, 'MeshDensity', 500,'HandleVisibility','off');
                ...
                for m=1:length(xaxish)
                    for n = 1:length(yaxish)
                        ...
                        if isreal(Lkv)==1&& Lkv >0 &&xt>minx &&yt>miny
                            hold on
                            plot([xt,xt],[yt,yt],'MarkerFaceColor',CMK(2*j+countk,:),'MarkerEdgeColor',CMK(2*j+countk,:),'MarkerSize',8,...
                                'Marker','+',...
                                'LineStyle','-','LineWidth',2, 'HandleVisibility','off');
                        elseif isreal(Lkv)==1&& Lkv<0 &&xt>minx &&yt>miny
                            hold on
                            plot([xt,xt],[yt,yt],'MarkerFaceColor',CMK(2*j+countk,:),'MarkerEdgeColor',CMK(2*j+countk,:),'MarkerSize',10,...
                                'Marker','_',...
                                'LineStyle','-','LineWidth',2, 'HandleVisibility','off');
                        end      
                    end
