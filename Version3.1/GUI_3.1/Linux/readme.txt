...
Note: This is a stand-alone GUI>  It is not necessary to have Matlab. We can not guarantee that this Augmented Phase Plane application will work on all linux set ups.  
We provide instructions below for both cases, if you have Matlab and if you do not.

Matlab R2023b Runtime must be used. It is available for free.  
Please see MATLAB's R2023b system requirements here - https://www.mathworks.com/support/requirements/matlab-linux.html
Note: This app was built using Matlab R2023b.  


Instructions for Linux Users who have Matlab Install
